...
* @prop {string} [CAPATH]
* @prop {number | bigint} [CA_CACHE_TIMEOUT]
...
* @prop {number | bigint} [MAIL_RCPT_ALLOWFAILS]
...
* @prop {number | bigint} [QUICK_EXIT]
* @prop {string[]} [QUOTE]
* @prop {string} [RANDOM_FILE]
* @prop {string} [RANGE]
* @prop {number | bigint} [REDIR_PROTOCOLS]
* @prop {string} [REDIR_PROTOCOLS_STR]
* @prop {string} [REFERER]
...
* @prop {number | bigint} [SERVER_RESPONSE_TIMEOUT_MS]
...
* @prop {string} [SSL_SIGNATURE_ALGORITHMS]
...
* @prop {number | bigint} [TCP_KEEPCNT]
...
* @prop {number | bigint} [UPLOAD_FLAGS]
* @prop {string} [URL]
