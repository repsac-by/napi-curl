...
/**
 * @typedef {'EFFECTIVE_URL'|'RESPONSE_CODE'|'TOTAL_TIME'|'NAMELOOKUP_TIME'|'CONNECT_TIME'|'PRETRANSFER_TIME'|'SIZE_UPLOAD_T'|'SIZE_DOWNLOAD_T'|'SPEED_DOWNLOAD_T'|'SPEED_UPLOAD_T'|'HEADER_SIZE'|'REQUEST_SIZE'|'SSL_VERIFYRESULT'|'FILETIME'|'FILETIME_T'|'CONTENT_LENGTH_DOWNLOAD_T'|'CONTENT_LENGTH_UPLOAD_T'|'STARTTRANSFER_TIME'|'CONTENT_TYPE'|'REDIRECT_TIME'|'REDIRECT_COUNT'|'PRIVATE'|'HTTP_CONNECTCODE'|'HTTPAUTH_AVAIL'|'PROXYAUTH_AVAIL'|'OS_ERRNO'|'NUM_CONNECTS'|'SSL_ENGINES'|'COOKIELIST'|'FTP_ENTRY_PATH'|'REDIRECT_URL'|'PRIMARY_IP'|'APPCONNECT_TIME'|'CONDITION_UNMET'|'RTSP_SESSION_ID'|'RTSP_CLIENT_CSEQ'|'RTSP_SERVER_CSEQ'|'RTSP_CSEQ_RECV'|'PRIMARY_PORT'|'LOCAL_IP'|'LOCAL_PORT'|'HTTP_VERSION'|'PROXY_SSL_VERIFYRESULT'|'SCHEME'|'TOTAL_TIME_T'|'NAMELOOKUP_TIME_T'|'CONNECT_TIME_T'|'PRETRANSFER_TIME_T'|'STARTTRANSFER_TIME_T'|'REDIRECT_TIME_T'|'APPCONNECT_TIME_T'|'RETRY_AFTER'|'EFFECTIVE_METHOD'|'PROXY_ERROR'|'REFERER'|'CAINFO'|'CAPATH'|'XFER_ID'|'CONN_ID'|'QUEUE_TIME_T'|'USED_PROXY'|'POSTTRANSFER_TIME_T'|'EARLYDATA_SENT_T'|'HTTPAUTH_USED'|'PROXYAUTH_USED'|'SIZE_DELIVERED'} Curlinfo
 */
